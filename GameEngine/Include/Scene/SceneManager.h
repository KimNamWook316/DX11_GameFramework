...
public:
	...
	{
		mCreateSceneModeCallBack = std::bind(func, std::placeholders::_1, std::placeholders::_2);
	}

	template<typename T>
	void SetCreateObjectCallBack(T* obj, void(T::* func)(CScene*, size_t))
	{
		mCreateObjectCallBack = std::bind(func, std::placeholders::_1, std::placeholders::_2);
	}
