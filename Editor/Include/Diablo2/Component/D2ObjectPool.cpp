...
{
 //	{
 //		auto iter = mMapSkillObject.begin();
 //		auto iterEnd = mMapSkillObject.end();
 //
 ...
 //
 //	{
 //		auto iter = mMapEffectObject.begin();
 //		auto iterEnd = mMapEffectObject.end();
 //
 //		for (; iter != iterEnd; ++iter)
 //		{
 //			auto iterList = iter->second.ActiveList.begin();
 //			auto iterListEnd = iter->second.ActiveList.end();
 //
 ...
 //			}
 //
 //			auto iterList2 = iter->second.InActiveList.begin();
 //			auto iterListEnd2 = iter->second.InActiveList.end();
 //
 //			for (; iterList2 != iterListEnd2; ++iterList2)
 //			{
 //				SAFE_RELEASE((*iterList2));
 //			}
 //		}
 //	}
 //
 //	{
 //		auto iter = mMapInteractionObject.begin();
 //		auto iterEnd = mMapInteractionObject.end();
 //
 //		for (; iter != iterEnd; ++iter)
 //		{
 //			auto iterList = iter->second.ActiveList.begin();
